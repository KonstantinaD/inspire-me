...
public class Comment {
    @Id
    @GeneratedValue //JPA annotations to indicate it’s the primary key and automatically populated by the JPA provider
    ...
    //don't include the foreign key relationship tables (entities) in this class constructor
